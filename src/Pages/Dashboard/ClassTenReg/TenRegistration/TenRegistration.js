...
import ModalTen from '../ModalTen/ModalTen';
...
const TenRegistration = () => {
    ...
    return (
        ...
        alignItems="center"  spacing={2}  style={{width:'80vw'}} >
                ...
                <Typography variant="h5" style={{color:'#4c0258'}} >Class Ten Student Registration</Typography>
...
export default TenRegistration;