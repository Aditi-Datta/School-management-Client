...
import ModalNine from '../ModalNine/ModalNine';
...
const NineRegistration = () => {
    ...
    return (
        ...
        alignItems="center"  spacing={2}  style={{width:'80vw'}} >
                ...
                <Typography variant="h5" style={{color:'#4c0258'}} >Class Nine Student Registration</Typography>
...
export default NineRegistration;