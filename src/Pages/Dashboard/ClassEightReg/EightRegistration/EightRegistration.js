...
import ModalEight from '../ModalEight/ModalEight';
...
const EightRegistration = () => {
    ...
    return (
        ...
        alignItems="center"  spacing={2}  style={{width:'80vw'}} >
                ...
                <Typography variant="h5" style={{color:'#4c0258'}} >Class Eight Student Registration</Typography>
...
export default EightRegistration;