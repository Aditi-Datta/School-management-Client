...
const IctAttendanceTableEight = () => {
    ...
    const  handleAttendanceValueSubmit = e => {
        // collect data
        const url = `https://secure-temple-79203.herokuapp.com/ictEightAttendance`;
    ...
    return (
        ...
        <Navigation></Navigation>
            <div>
                <h2 style={{ textAlign: "center", color: 'green', margin: 20 }}>Class 8 ICT Attendance Table</h2>
...
export default IctAttendanceTableEight;