...
const SociologyAttendanceTableSix = () => {
    const { user } = useAuth();
    ...
    useEffect(() => {
        const url = `https://secure-temple-79203.herokuapp.com/classSixStudent`;
        fetch(url)
            .then((res) => res.json())
            .then((data) => {
    ...
    const  handleAttendanceValueSubmit = e => {
        // collect data
        const url = `https://secure-temple-79203.herokuapp.com/sociologySixAttendance`;
    ...
    return (
        ...
        <Navigation></Navigation>
            <div>
                <h2 style={{ textAlign: "center", color: 'green', margin: 20 }}>Class 6 Sociology Attendance Table</h2>
...
export default SociologyAttendanceTableSix;