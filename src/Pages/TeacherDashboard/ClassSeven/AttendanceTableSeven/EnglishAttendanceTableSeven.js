...
const EnglishAttendanceTableSeven = () => {
    ...
    const  handleAttendanceValueSubmit = e => {
        // collect data
        const url = 'https://secure-temple-79203.herokuapp.com/englishSevenAttendance';
    ...
    return (
        ...
        <div>
        <h2 style={{ textAlign: "center", color: 'green', margin: 20 }}>Class 7 English Attendance Table</h2>
        </div>
