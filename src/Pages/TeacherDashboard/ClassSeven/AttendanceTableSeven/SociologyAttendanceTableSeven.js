...
const SociologyAttendanceTableSeven = () => {
    const { user } = useAuth();
    ...
    const  handleAttendanceValueSubmit = e => {
        // collect data
        const url = 'https://secure-temple-79203.herokuapp.com/sociologySevenAttendance';
    ...
    return (
        ...
        <div>
        <h2 style={{ textAlign: "center", color: 'green', margin: 20 }}>Class 7 Sociology Attendance Table</h2>
        </div>
...
export default SociologyAttendanceTableSeven;
