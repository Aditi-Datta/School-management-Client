...
const SociologyAttendanceTableNine = () => {
    const { user } = useAuth();
    ...
    const  handleAttendanceValueSubmit = e => {
        // collect data
        const url = `https://secure-temple-79203.herokuapp.com/sociologyNineAttendance`;
    ...
    return (
        ...
        <Navigation></Navigation>
            <div>
                <h2 style={{ textAlign: "center", color: 'green', margin: 20 }}>Class 9 Sociology Attendance Table</h2>
...
export default SociologyAttendanceTableNine;